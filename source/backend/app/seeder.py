...
async def seed_data():
    ...
    async with async_session_maker() as session:
        ...
        if existing_courses:
            logger.info(
                "Courses already seeded for admin. Skipping seeder database load."
            )
            return
        ...
        m1_3 = Module(
            id=uuid.uuid4(),
            course_id=course1.id,
            title="Hàm & Lập trình hướng đối tượng",
            order_index=3,
        )
        ...
        l1_3 = Lesson(
            ...
            course_id=course1.id,
            module_id=m1_1.id,
            title="Bài kiểm tra trắc nghiệm đầu khóa",
            type="quiz",
            order_index=3,
            student_count=40,
        )
        ...
        l1_7 = Lesson(
            ...
            course_id=course1.id,
            module_id=m1_3.id,
            title="Định nghĩa Hàm (Functions)",
            type="video",
            order_index=7,
        ...
        m2_1 = Module(
            ...
            title="Cơ bản về React & Component",
            order_index=1,
        )
        m2_2 = Module(
            id=uuid.uuid4(),
            course_id=course2.id,
            title="Xây dựng Backend với FastAPI",
            order_index=2,
        )
        ...
        l2_1 = Lesson(
            ...
            course_id=course2.id,
            module_id=m2_1.id,
            title="Giới thiệu JSX và Component",
            type="video",
            order_index=1,
        ...
        l2_3 = Lesson(
            ...
            course_id=course2.id,
            module_id=m2_1.id,
            title="Quản lý State nâng cao với Redux",
            type="video",
            order_index=3,
        ...
        l2_4 = Lesson(
            ...
            course_id=course2.id,
            module_id=m2_2.id,
            title="Giới thiệu FastAPI & Uvicorn",
            type="video",
            order_index=4,
            duration_seconds=600,
            student_count=15,
        ...
        l2_5 = Lesson(
            ...
            course_id=course2.id,
            module_id=m2_2.id,
            title="Kết nối Database với SQLAlchemy",
            type="video",
            order_index=5,
            duration_seconds=1000,
            student_count=15,
        ...
        m3_1 = Module(
            ...
            title="Giới thiệu Trí tuệ Nhân tạo",
            order_index=1,
        )
        m3_2 = Module(
            id=uuid.uuid4(),
        ...
        l3_2 = Lesson(
            ...
            course_id=course3.id,
            module_id=m3_1.id,
            title="Các thuật toán học máy phổ biến",
            type="video",
            order_index=2,
            duration_seconds=600,
            student_count=10,
        ...
        l3_3 = Lesson(
            ...
            course_id=course3.id,
            module_id=m3_2.id,
            title="Toán học trong hồi quy tuyến tính",
            type="video",
            order_index=3,
            duration_seconds=1200,
            student_count=5,
        ...
        for idx, se in enumerate(enrollments1):
            ...
            activities.append(
                LearningActivity(
                    ...
                    video_stop_at_second=(
                        180 if idx % 3 == 0 else (350 if idx % 2 == 0 else None)
                    ),
                    is_completed=True,
                )
            )
        ...
        for idx, se in enumerate(enrollments2):
            ...
            activities.append(
                LearningActivity(
                    ...
                    video_stop_at_second=(
                        420 if idx % 3 == 0 else (600 if idx % 2 == 0 else None)
                    ),
